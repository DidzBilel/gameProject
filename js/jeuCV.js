...
var game = function () {
    $(document).ready(function () {
        ...
        // - Apparition et disparition du synopsis.
        ...
        var scoreIncrement = function () {
            ...
            if (scoreValue === 1500) {
                ...
                // - Création et ajout du gif d'animation de fin
                ...
                // - Création et ajout du bouton de rechargement
                var buttonReload = document.createElement('button');
                buttonReload.innerHTML = 'Reload';
                buttonReload.style.position = 'absolute';
                buttonReload.style.width = '100px';
                buttonReload.style.height = '35px';
                buttonReload.style.left = '70px';
                buttonReload.style.top = '165px';
                buttonReload.style.fontSize = '25px';
                buttonReload.style.fontFamily = 'saiyan';
                buttonReload.className = 'redSaiyan';
                gameFrame.appendChild(buttonReload);

                // - Event permettant de rafraîchir la page.
